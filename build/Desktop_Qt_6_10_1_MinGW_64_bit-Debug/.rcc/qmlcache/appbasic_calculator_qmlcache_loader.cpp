...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appbasic_calculator)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appbasic_calculator))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appbasic_calculator)() {
    return 1;
}
